...
@NamedQueries
        ({
                ...
                @NamedQuery(name = "Adresses.findAllNotAdBibliNotUti", query = "SELECT a FROM Adresses a WHERE a.bibliotheques IS NULL and a.idAdresses not in (select ua.adresse.idAdresses from UtilisateursAdresses ua)"),
