...
public class ModelFactBiblio implements Serializable
{
	...
	public void creation (Intervention interv, List<Action> listAction) throws IOException
	{
	  ...
	  //Cr�ation de l'�tiquette du client
	    ...
	    String pdp2 = "Toutes nos factures doivent �tre pay� au moment de la cr�ation de la facture. Toute heure commenc�e est due ";
	    String pdp3 = "Les commandes sont disponibles au maximum 15 jours apr�s la commande ";
